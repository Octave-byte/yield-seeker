...
tab1, tab2 = st.tabs(["Yield Seeker & Optimizer", "Find the Best Yield in Town"])
...
with tab2: 
    ...
    if st.button("Find Best Yield"):
        best_yield_opportunities = utils.find_best_opportunities(selected_verticals, min_tvl_yield, underlying_assets)
